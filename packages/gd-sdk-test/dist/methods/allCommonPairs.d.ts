 ...
 */
export declare const allCommonPairs: ((chainId: SupportedChainId, currencyA?: Currency | undefined, currencyB?: Currency | undefined) => Promise<Pair[]>) & import("lodash").MemoizedFunction;
