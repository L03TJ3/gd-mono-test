 ...
 */
export declare const allCurrencyCombinations: ((chainId: SupportedChainId, currencyA?: Currency | undefined, currencyB?: Currency | undefined) => Promise<Array<[Currency, Currency]>>) & import("lodash").MemoizedFunction;
